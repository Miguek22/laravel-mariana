      ...
      <form method="post" action="{{route('product.update',$product->id)}}">
        ...
        <div class="form-group">
          ...
          <select name="size[]" class="form-control selectpicker"  multiple data-live-search="true">
              ...
              <option value="XL"  @if( in_array( "XL",$data ) ) selected @endif>Muy grande</option>
              @endforeach
          </select>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <select name="condition" class="form-control">
              ...
              <option value="default" {{(($product->condition=='default')? 'selected':'')}}>Por defecto</option>
              <option value="new" {{(($product->condition=='new')? 'selected':'')}}>Nuevo</option>
              <option value="hot" {{(($product->condition=='hot')? 'selected':'')}}>Usado</option>
          </select>
        </div>
